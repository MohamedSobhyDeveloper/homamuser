...
import com.otex.homamuser.view.orderdetail.model.Detail


class AdditionalCartOrderDetailsAdapter(private val context: Context, val mList: List<Detail>)
    : RecyclerView.Adapter<AdditionalCartOrderDetailsAdapter.MyViewHolder>() {
